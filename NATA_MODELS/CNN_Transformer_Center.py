...
if __name__ == "__main__":
    ...
    train_video_ids = ['20231123_10min_OFT-BL_3961', '20231123_10min_OFT-BL_3962', '20231123_10min_OFT-BL_3963',
    ...
    val_video_ids = ['20231123_10min_OFT-BL_3919', '20231123_10min_OFT-BL_4029',
                     'BehavioralCamera2023-02-19T14_53_53_shorter', 'BehavioralCamera2023-03-09T14_30_45', 'MBT1-M14',
                     'MBT1-M3', 'T10', 'T3', 'T7']
    test_video_ids = ['20231123_10min_OFT-BL_4025', '3279_21min_behaviour_2023-01-19T12_57_29',
    ...
    plt.tight_layout()
    plt.savefig(f'./output/cnn_transformer/conf_matrix_train_{DATASET_VERSION}.png', dpi=300, bbox_inches='tight')
    plt.close()
    ...
    plt.xlabel('Predicted Label')
    plt.tight_layout()
    plt.savefig(f'./output/cnn_transformer/conf_matrix_val_{DATASET_VERSION}.png', dpi=300, bbox_inches='tight')
    plt.close()
    ...
    plt.xlabel('Predicted Label')
    plt.tight_layout()
    plt.savefig(f'./output/cnn_transformer/conf_matrix_test_{DATASET_VERSION}.png', dpi=300, bbox_inches='tight')
    plt.close()
    ...
    if plot_behavior_names:
        ...
        plt.tight_layout()
        plt.savefig(f'./output/cnn_transformer/behaviour_instance_count_{DATASET_VERSION}.png',
    ...
    if per_video_data and plot_behavior_names:
        ...
        plt.tight_layout()
        plt.savefig(f'./output/cnn_transformer/instance_count_per_video_{DATASET_VERSION}.png',
                    dpi=300, bbox_inches='tight')
        plt.close()
        print("\nInstance count per video scatterplot saved!")

    # Save evaluation results
    results_path = f'./output/cnn_transformer/evaluation_{DATASET_VERSION}.txt'
