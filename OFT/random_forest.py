...
LABELS_DIR = ROOT_DIR / "labels_new"

TEST_SIZE = 0.2
RANDOM_STATE = 42

BEHAVIOR_COLUMNS = ["background", "Supportedrearing", "Unsupportedrearing", "Grooming", "Digging"]
...
for feature_path in feature_files:
    ...
    label_path = LABELS_DIR / f"{handle}_labels.csv"
