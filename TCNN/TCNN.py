...
WINDOW_SIZE = 31
BATCH_SIZE = 32
TRAIN_VIDEO_NAMES = ['MBT1-M10', '20231123_10min_OFT-BL_3961', '20231123_10min_OFT-BL_3962', '20231123_10min_OFT-BL_3963', '20231123_10min_OFT-BL_3964', '20231123_10min_OFT-BL_4028', '3278_21min_behaviour_2023-01-19T11_08_30', 'BehavioralCamera2023-02-14T13_05_19_shorter', 'BehavioralCamera2023-02-14T15_22_37_shorter', 'BehavioralCamera2023-02-15T14_40_46_shorter', 'BehavioralCamera2023-02-18T10_33_06_shorter', 'BehavioralCamera2023-02-18T12_37_43_shorter', 'BehavioralCamera2023-02-23T15_42_37_shorter', 'BehavioralCamera2023-03-09T10_37_32', 'BehavioralCamera2023-03-09T11_04_40', 'BehavioralCamera2023-03-09T11_41_07', 'BehavioralCamera2023-03-09T12_34_50', 'BehavioralCamera2023-03-09T13_02_04', 'MBT1-M11', 'MBT1-M15', 'MBT1-M18', 'MBT1-M2', 'MBT1-M6', 'T1', 'T12', 'T13', 'T14', 'T16', 'T17', 'T18', 'T19', 'T2', 'T5', 'T8', 'T9']
...
weights = torch.tensor([0.5, 3.4, 7, 4, 3], dtype=torch.float)
loss_fn = FocalLoss(weight=weights.to(device))
optimizer = torch.optim.AdamW(params = network.parameters(), lr = 5e-5)
...
for epoch in range(1, 21):
    ...
    train_model(dataloaders = train_dataloaders, network = network, loss_fn = loss_fn, optimizer = optimizer, device = device)
    test_model(dataloaders = test_dataloaders, network = network, loss_fn = loss_fn, device = device, output_folder = OUTPUT_FOLDER)
    scheduler.step()
