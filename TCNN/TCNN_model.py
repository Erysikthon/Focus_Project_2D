...
class TCNN(Module):
    def __init__(self):
        ...
        self.block1 = Sequential(*[ResBlock(32) for whatever in range(0, 6)])
        ...
        self.block2 = Sequential(*[ResBlock(48) for whatever in range(0, 6)])
        ...
        self.block3 = Sequential(*[ResBlock(64) for whatever in range(0, 6)])
